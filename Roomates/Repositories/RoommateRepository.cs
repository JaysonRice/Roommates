    ...
    class RoommateRepository : BaseRepository
    {
            ...
            using (SqlConnection conn = Connection)
            {
                ...
                using (SqlCommand cmd = conn.CreateCommand())
                {
                    ...
                    while (reader.Read())
                    {
                        ...
                        int dateTimeColumnPosition = reader.GetOrdinal("MoveInDate");
                        DateTime dateTimePortionValue = reader.GetDateTime(dateTimeColumnPosition);
                        ...
                        Roommate roommate = new Roommate
                        {
                            ...
                            MoveInDate = dateTimePortionValue,
                            Room = null
                        };
        ...
        public List<Roommate> GetAllWithRoom(int roomId)
        {
            using (SqlConnection conn = Connection)
            {
                ...
                using (SqlCommand cmd = conn.CreateCommand())
                {
                    cmd.CommandText = @$"SELECT roommate.FirstName, 
                                                roommate.LastName, 
